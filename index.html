...
<body id="t" class="neterror" style="font-family: 'Segoe UI', Tahoma, sans-serif; font-size: 75%">
  <div id="main-frame-error" class="interstitial-wrapper">
    <div id="main-content">
      <div class="icon icon-offline"></div>
      <div id="main-message">
        <h1>
          <span>No Bitches</span>
        </h1>
            ...
            <div id="error-information-popup-box">
              <div id="error-information-popup-content">
                <div id="suggestions-list">
                  ...
                  <ul>
                    <li>Going outside</li>
                    <li>Talking to women</li>
                    <li><a href="https://www.wikihow.life/Take-a-Shower" id="diagnose-link">Taking a shower</a></li>
                  </ul>
                </div>
                <div class="error-code">YOU GET NO BITCHES</div>
              </div>
            </div>
          </div>
        </div>
